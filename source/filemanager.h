...
**/
EXTERN_C file_t * API create_file_manager(const char * file_path, const char * mode);
...
**/
EXTERN_C void API write_to_file(file_t * file, const char * text);
...
**/
EXTERN_C char * API read_from_file(file_t * file);
...
**/
EXTERN_C void   API close_file_manager(file_t * file);
...
**/
EXTERN_C void   API set_file_stream_position(file_t * file, unsigned int position);
...
**/
EXTERN_C void   API buffer_read_file(char * buffer, unsigned int size, file_t * file);
